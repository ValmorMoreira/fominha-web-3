                ...
                <div class="card-panel-new">
                    ...
                    enctype="mulyipart/form-data">
                        ...
                        <div class="input-field col s12">
                            ...
                            <textarea minlength="10" aria-required="true" name="modo_de_preparo" id="modo_de_preparo"
                                class="materialize-textarea" data-error="Por favor descreva o modo de preparo."
                                required></textarea>
