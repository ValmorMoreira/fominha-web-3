...
<main>
    ...
    <!--Teste de filtro-->
    <div class="row container vertical-align">
        <form action="<?= URL_RAIZ . 'receitas' ?>" method="POST">
            <div class="col l6 s6">
                <?php if ($ordenar == 'desc') : ?>
                    <button type="submit" class="btn red darken-4" name="ordenar" value="asc">Ordenar por data  crescente</button>
                <?php endif ?>
                <?php if ($ordenar == 'asc') : ?>
                    <button type="submit" class="btn red darken-4" name="ordenar"  value="desc" >Ordenar por data decrescente</button>
                <?php endif ?>       
            </div>
    </form>
    ...
    <div class="container">
        <div class="row">
            ...
            <?php if (count($receitas) == 0) : ?>
                <h1 class="success-text">Sem resultados para: <?= $this->getGet('busca') ?></h1>
            <?php endif ?>
